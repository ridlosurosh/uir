  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Lowker</span>
        <?php $jmld = $this->model_app->view('lowongan')->num_rows(); ?>
...
<section class="col-lg-7 connectedSortable">
  ...
  <div class='box'>
    ...
    <div class='box-body'>
      ...
      <a href="<?php echo base_url().$this->uri->segment(1); ?>/menugroup" class='btn btn-app'><i class='fa fa-th-large'></i> Group</a>
      <a href="<?php echo base_url().$this->uri->segment(1); ?>/menugrouplist" class='btn btn-app'><i class='fa fa-th-large'></i> Group List</a>
      ...
      <a href="<?php echo base_url().$this->uri->segment(1); ?>/lowker" class='btn btn-app'><i class='fa fa-archive'></i> Lowker</a>
      <a href="<?php echo base_url().$this->uri->segment(1); ?>/agenda" class='btn btn-app'><i class='fa fa-calendar-minus-o'></i> Agenda</a>
      <a href="<?php echo base_url().$this->uri->segment(1); ?>/download" class='btn btn-app'><i class='fa fa-external-link'></i> Link</a>
